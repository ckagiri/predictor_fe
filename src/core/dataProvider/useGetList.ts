 ...
 *
 * @param {string} resourceName The resource name, e.g. 'posts'
 * @param {string} resourcePath The api path to the resource e.g. '/authorId/posts'
